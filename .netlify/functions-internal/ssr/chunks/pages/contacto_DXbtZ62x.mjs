...
const $$Contacto = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contactanos", "descriptions": "Contactanos hoy mismo", "footer": "v2" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container mx-auto"> <h1 class="
        font-Bebas-Neue text-5xl md:text-6xl pb-5 text-yellow-700 text-center
        p-10
        ">Contactanos</h1> <div class="col-span-2 order-1 md:order-2 py-8"> <div class="grid md:grid-cols-2 gap-4"> <div class="border border-zinc-500 p-3"> <div class="relative w-full h-full"> <iframe class="absolute top-0 left-0 w-full h-full" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3756.3584712609995!2d-98.98006178844165!3d19.697356732094352!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1ed19a652adbd%3A0x37f45662d04a2e0a!2sALUVITEC!5e0!3m2!1ses-419!2smx!4v1718233397884!5m2!1ses-419!2smx" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0">
...
Contactanos
</h3> <ul class="text-xl"> <li><a href="tel:59360365" target="_self"><i class="fas fa-phone-alt"></i> 5936 0365</a></li> <li><a href="tel:59362789" target="_self"><i class="fas fa-phone-alt"></i> 5936 2789</a></li> <li><a href="tel:59363562" target="_self"><i class="fas fa-phone-alt"></i> 5936 3562</a></li> <li><a href="tel:63593952" target="_self"><i class="fas fa-phone-alt"></i> 6359 3952</a></li> </ul> </div> <div class="pb-10"> <h3 class="font-Bebas-Neue text-5xl text-zinc-400">Whatsapp</h3> <a href="https://wa.link/5q1zrg" target="_blank" class="text-xl"> <i class="fab fa-whatsapp"></i>
Envar mensaje
</a> </div> <div class=""> <h3 class="font-Bebas-Neue text-5xl text-zinc-400">
Horarios de lunes a viernes</h3> <ul class="text-xl"> <li><i class="far fa-clock"></i> de 8:30am - 2:00 pm</li> <li><i class="far fa-clock"></i> y de 3:15pm a 6:00pm</li> </ul> </div> </div> </div> </div> </div> ` })}`;
