...
import { $ as $$LogosProveedores } from './index_Co5Y0Boy.mjs';
...
</p> </div> <!-- //! --> <div class="p-10"> ${renderComponent($$result2, "LogosProveedores", $$LogosProveedores, {})} </div> <!-- //! --> <div class="grid md:grid-cols-2 gap-4 mb-12 px-12 text-center"> <div class="border-2 border-zinc-500 p-5"> <h3 class="font-Bebas-Neue text-4xl pb-3">Visión</h3> <p class="text-zinc-500 text-2xl">Ser en 2030 una de las principales distribuidoras de perfil arquitectónico, cristal y herraje a nivel nacional con soluciones integrales que van desde la compra hasta la logística en la entrega.</p> </div> <div class="border-2 border-zinc-500 p-5"> <h3 class="font-Bebas-Neue text-4xl pb-3">Misión</h3> <p class="text-zinc-500 text-2xl">Brindar a todos nuestros clientes un servicio de calidad ofreciendo soluciones integrales a la medida cuidando la relación calidad precio en toda nuestra línea de productos </p> </div> </div> <div class="grid md:grid-cols-2 gap-5 md:px-48 mx-auto"> <div> <img src="./images/logo/logo_lineas.svg" class="w-screen"> </div> <div class="ml-40 md:ml-10"> <h3 class="font-Bebas-Neue text-4xl pb-3">Valores</h3> <ul class="list-disc pl-5 text-sm text-zinc-400"> <li>Responsabilidad</li> <li>Honradez</li> <li>Solidaridad</li> <li>Empatía</li> <li>Compromiso</li> <li>Integridad</li> <li>Excelencia</li> <li>Servicio</li> </ul> </div> </div> </div> ` })}`;
