...
"> <p class="font-Bebas-Neue text-3xl md:text-4xl animate-pulse">${title}</p> <p class="font-thin text-lg">Mandanos mensaje o llama ahora, con gusto te atenderemos</p> <div class="py-5 md:space-x-2 space-y-2"> <a${addAttribute(`https://api.whatsapp.com/send?phone=5215565819341&text=${message}`, "href")} class="py-3 px-5 bg-green-700 border border-green-400 rounded-md transition hover:bg-green-800 duration-300 ease-in-out block md:inline" href="" target="_blank"> <i class="fab fa-whatsapp"></i> Mandar mensaje
