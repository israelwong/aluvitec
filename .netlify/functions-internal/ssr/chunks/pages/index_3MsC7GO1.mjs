...
Procesos en cristal</h1> <p class="pt-2"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 mx-auto animate-pulse"> <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3"></path> </svg> </p> </a> ` })} <!-- //? --> <!-- //? --> ${renderComponent($$result2, "Fade", Fade, { "client:visible": true, "delay": 600, "client:component-hydration": "visible", "client:component-path": "react-awesome-reveal", "client:component-export": "Fade" }, { "default": ($$result3) => renderTemplate` <a class="grid grid-cols-4 grid-flow-col bg-zinc-900 py-5 rounded mb-5 border border-zinc-700  hover:animate-pulse" href="./productos/herrajes"> <div class="text-center"> <i class="text-3xl fab fa-hive"></i> </div> <h1 class="text-left col-span-2 text-lg pt-1">
...
const $$Productos = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="mx-auto container"> <div class="
        ...
        p-12
        "> <a href="./productos"> <img src="./images/btn_aluminio.png" alt="Aluminio" class="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"> </a> <a href="./productos"> <img src="./images/btn_cristal.png" alt="Cristal" class="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"> </a> <a href="./productos"> <img src="./images/btn_herrajes_aluminio.png" alt="Herrajes para perfiles de aluminio" class="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"> </a> <a href="./productos"> <img src="./images/btn_herrajes_cristal.png" alt="Herrajes para cristales" class="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"> </a> </div> <div class="text-center"> <p class="
            font-Bebas-Neue 
            text-yellow-600 
            py-5 
            text-2xl
