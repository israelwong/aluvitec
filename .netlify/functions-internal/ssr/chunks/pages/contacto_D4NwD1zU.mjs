...
Horario</h3> <ul class="text-xl"> <li><i class="far fa-clock"></i> Lunes a viernes de 8:30am - 2:00 pm</li> <li><i class="far fa-clock"></i> y de 3:15pm a 6:00pm</li> </ul> </div> </div> </div> </div> </div> ` })}`;
